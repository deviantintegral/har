...
if [ ! -f "infection.phar" ]; then
    ...
    wget https://github.com/infection/infection/releases/download/0.33.3/infection.phar
    wget https://github.com/infection/infection/releases/download/0.33.3/infection.phar.asc
