...
if [ ! -f "infection.phar" ]; then
    ...
    wget https://github.com/infection/infection/releases/download/0.35.4/infection.phar
    wget https://github.com/infection/infection/releases/download/0.35.4/infection.phar.asc
